  ...
  return (
    <div className='mx-4'>
        ...
        <div className={`row mx-lg- mx-xxl- mx-xl-3 mx-md-3 my-1 mb-1 text-${props.mode==='dark'?'white':'body'} `}>
                ...
                <div className="col-lg-2 col-md-4 col-6 col-xl-2 col-xxl-2 col-xs-6">
                <Grocery mode={props.mode} notify={props.notify} img={img5} category="Grocery" title="Olitalia Sunflower Oil 5ltr" offerPrice="tk. 155.00" price="105.00"></Grocery>
                </div>
                <div className="col-lg-2 col-md-4 col-6 col-xl-2 col-xxl-2 col-xs-6">
               ...
               <div className="mx-4">
        <Grocery mode={props.mode} notify={props.notify} img={img4} category="Grocery" offerPrice="tk. 170.00" title="Span Virgin Olive Oil 1ltr" price="145.00"/>
        </div>
               {/* pagination */}
