...
export default function Product(props) {
  ...
  return (
    <div className=''>
        <div className=" my-5 ">
            <div className={`row mx-lg-3 my-1 mb-1 text-${props.mode==='dark'?'white':'body'} `}>
            <Category mode={props.mode} category="Cooking Oil & Ghee"> </Category><hr />
            <div className="row ">
                <div className="col-lg-2 col-md-4 col-sm-6 col-xl-2 col-xxl-2">
...
{/* --------------------------------------------------Dairy-------------------------- */}
        <div className="mx-lg my-5 ">
            <div className={`row mx-lg-3 my-1 mb-1 text-${props.mode==='dark'?'white':'body'} bg-${props.mode==='dark'?'secondary':'body'}`}>
                <div className="col-9">
            ...
            <div className={`row mx-3 my-1 mb-1 text-${props.mode==='dark'?'white':'body'}`}>
                <div className={`col-lg-2 col-sm-6 col-md-6 mb-1  `}>
