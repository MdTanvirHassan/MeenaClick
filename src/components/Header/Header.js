  ...
  <div className="offcanvas-body">
    ...
    <div className="dropdown mt-3">
      ...
      <ul className="dropdown-menu">
        ...
        <form className="col-12 col-lg-4 mb-3 mb-lg-0 me-lg-0 text-center"  role="search">
          <input type="search" className="form-control border-success text-end" placeholder="Search Here..." aria-label="Search"/>
        </form>
