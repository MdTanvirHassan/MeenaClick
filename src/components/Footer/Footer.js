...
export default function Footer(props) {
  ...
  <footer className="py-0">
    ...
    <img src={logo} className="img-fluid  col-sm-12 collapse " alt="logo" />
      <div className="col-xl-3 col-xxl-3 col-xl-3 col-lg-3 col-md-6 mb-1 ">
        ...
        <ul className="nav flex-column">
          ...
          <li className="nav-item mb-1"><a href='/' className={`nav-link p-0 text-${props.mode==='dark'?'white':'white'}`}><small>Frequently Asked Questions</small></a></li>
          <li className="nav-item mb-1"><a href='/' className={`nav-link p-0 text-${props.mode==='dark'?'white':'white'}`}><small>Terms and Conditions</small></a></li>
          <li className="nav-item mb-1"><a href='/' className={`nav-link p-0 text-${props.mode==='dark'?'white':'white'}`}><small>Privacy Policy</small></a></li>
      ...
      <div className="col-xl-3 col-xxl-3 col-xl-3 col-lg-3 col-md-6 mb-1">
        ...
        <ul className="nav flex-column">
          ...
          <li className="nav-item mb-1"><a href='/' className={`nav-link p-0 text-${props.mode==='dark'?'white':'white'}`}><small>Shipping and Delivery</small></a></li>
          <li className="nav-item mb-1"><a href='/' className={`nav-link p-0 text-${props.mode==='dark'?'white':'white'}`}><small>Customer Care</small></a></li>
          <li className="nav-item mb-1"><a href='/' className={`nav-link p-0 text-${props.mode==='dark'?'white':'white'}`}><small>Careers</small></a></li>
      ...
      <div className="col-xl-3 col-xxl-3 col-xl-3 col-lg-3 col-md-6 mb-1">
        ...
        <ul className="nav flex-column">
          ...
          <li className="nav-item mb-1"><a href='/' className={`nav-link p-0 text-${props.mode==='dark'?'white':'white'}`}> <small><i className=" bi bi-phone me-1"></i> 09678666111</small></a></li>
          <li className="nav-item mb-1"><a href='/' className={`nav-link p-0 text-${props.mode==='dark'?'white':'white'}`}> <small><i className=" bi bi-envelope-fill me-1"></i>care@meenaclick.com</small></a>
          </li>
          <li className="nav-item mb-1"><a href='/' className={`nav-link p-0 text-${props.mode==='dark'?'white':'white'}`}> <small><i className=" bi bi-escape me-1"></i>blog.meenaclick.com</small></a>
          </li>
    ...
    <div className={`d-flex flex-column flex-sm-row justify-content-between py-2 my- border-top text-${props.mode==='dark'?'white':'white'}`}>
      <p><small>&copy; 2017-2022 Meena Click Limited All Rights Reserved.</small></p>
